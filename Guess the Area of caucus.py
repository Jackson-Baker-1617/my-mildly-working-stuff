...
asia = ["JohnWetton","Tibet","Siberia","India","China","Afganistan","Armenia", "Azerbaijan", "Bahrain", "Bangladesh","bhutan","Brunei","Cambodia","Cyprus", "Georgia", "Indonesia","Iran","Iraq","Isreal","Japan","Jordan","Kazakhstan","North Korea","South Korea","Kuwait","Kyrgyzstan","Laos","Lebanon","Malaysia","Maldives","Mongolia","Myanmar","Nepal","Oman","Pakistan","Philippines","Qatar","Russia","Saudi Arabia","Singapore","Sri Lanka","Siam","Syria","Tajikistan","Thailand","Timor-Leste","East Timor","Turkey","Turkmenistan","United Arab Emirates","Uzbekistan","Vietnam","Viet Nam","Yemen","Abkhazia","Nagorno-Karabakh","Northern Cyprus","Palestine","South Ossetia","Taiwan","Akrotiri","Dhekelia","Brittish Indian Ocean Territory","Christmas Island","Cocos Islands","Keeling Islands","Hong Kong","Macau","Macao"]
#intergers
...
#Asks if you want to play and teaches you about earlobes if you act insuboridatly
def suicide():
    ...
    if quitter.lower()=="y":
        ...
        suicide()
#Goes through the first set of numbers/Asian Nations
def gameo():
...
#tells you when you are a faliure
def whylive():
    ...
    if ech.lower()=="y":
        ...
        whylive()
#tells you are winner and allows faster
def sofast():
...
def whylivefaster():
    ...
    if em.lower()=="y":
       ...
       whylivefaster()        
# i just didnt want to have to rewrite stuff higher up
def Mach2():
    gameofast()
#more importantly, why did i make this dev class?
